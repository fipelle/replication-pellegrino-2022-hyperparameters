...
save("iis_hyperparameters_20.jld2", Dict("hyper" => iis_hyperparameters, "err_grid" => iis_error_grid, "hyper_grid" => iis_hyper_grid));
...
save("oos_hyperparameters_20.jld2", Dict("hyper" => oos_hyperparameters, "err_grid" => oos_error_grid, "hyper_grid" => oos_hyper_grid));
...
save("ajk_hyperparameters_20.jld2", Dict("hyper" => ajk_hyperparameters, "err_grid" => ajk_error_grid, "hyper_grid" => ajk_hyper_grid));
...
save("bjk_hyperparameters_20.jld2", Dict("hyper" => bjk_hyperparameters, "err_grid" => bjk_error_grid, "hyper_grid" => bjk_hyper_grid));
