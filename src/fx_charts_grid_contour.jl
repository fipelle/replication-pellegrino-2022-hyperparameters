...
using Contour, DecisionTree, Random, StableRNGs, Statistics, MessyTimeSeries, MessyTimeSeriesOptim;
...
fig = @pgf TikzPicture(GroupPlot(
    { group_style = {group_size="4 by 2", vertical_sep="50pt", horizontal_sep="50pt"},
      height="150pt",
      width="225pt"
    },
